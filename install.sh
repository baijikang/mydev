...
echo '\n\n\n  * 下載 ndoejs'                                                                            && \
sleep 2                                                                                                 && \
wget -c  'https://npm.taobao.org/mirrors/node/v14.14.0/node-v14.14.0-linux-x64.tar.gz'                  && \
mkdir -p ~/opt/                                                                                         && \
tar -xf node-v14.14.0-linux-x64.tar.gz                                                                  && \
rm node-v14.14.0-linux-x64.tar.gz                                                                       && \
mv node-v14.14.0-linux-x64 ~/opt/node                                                                   && \
...
echo '         如果网络错误，就设置 hosts 在 www.ipaddress.com 查询 raw.githubusercontent.com 真实 host'                                    && \
echo '        - 打開 vim '                                                                                                                  && \
echo '        - 執行 :PlugInstall'                                                                                                          && \
echo '        - 執行 :CocUpdate'                                                                                                            && \
